...
public class Message {
	...
	public Message(String global, String hover, String response, String cantWakeup, Double chance) {
	...
	public Message fillPlaceHolders(Player p) {
		...
		Message res = new Message(global, hover, this.response, this.cantWakeup, this.chance);
		return res;
	}
}
